                    ...
                    <td style="padding: 28px 32px; font-size: 14px; line-height: 1.6; color: #333;">
                        ...
                        @if ($publicUrl)
                            <div style="text-align: center; margin-top: 24px;">
                                <a href="{{ $publicUrl }}" style="display: inline-block; padding: 12px 24px; background: #167c88; color: #fff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 14px;">View quotation online</a>
                            </div>
                        @endif
