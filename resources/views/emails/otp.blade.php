                ...
                <tr>
                    <td style="padding: 28px 32px; font-size: 15px; line-height: 1.6; color: #333;">
                        ...
                        <div style="text-align: center; margin: 24px 0;">
                            <div style="display: inline-block; padding: 14px 28px; background: #f3f4f6; border: 1px solid #e5e7eb; border-radius: 10px; font-size: 32px; font-weight: 800; letter-spacing: 8px; color: #0f766e; font-family: monospace;">{{ $code }}</div>
                        </div>
