        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <span class="inline-flex rounded overflow-hidden shadow-sm">
                <a href="{{ route('quotations.pdf', $quotation) }}"
                   class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gray-800 text-white text-sm font-semibold hover:bg-gray-900"
                ...
                <a href="{{ route('quotations.pdf', $quotation, false) . '?color=1' }}"
                   class="inline-flex items-center justify-center px-2.5 py-1.5 bg-gray-700 text-white hover:bg-gray-800 border-l border-gray-600"
            ...
            <button type="button" onclick="window.print()" class="print-keep inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-gray-300 text-gray-700 text-sm font-semibold rounded hover:bg-gray-50">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/></svg>
                Print
            </button>

            <a href="{{ $publicUrl }}" target="_blank" rel="noopener"
               class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-gray-300 text-gray-700 text-sm font-semibold rounded hover:bg-gray-50">
