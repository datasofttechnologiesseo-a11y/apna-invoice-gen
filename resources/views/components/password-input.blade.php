...
<div class="relative mt-1" x-data="{ show: false }">
    ...
    <button
        ...
        :aria-pressed="show"
        tabindex="-1"
        class="absolute top-1/2 right-2 -translate-y-1/2 p-1 text-gray-500 hover:text-gray-600 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-1 rounded">
