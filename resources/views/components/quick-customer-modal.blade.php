...
<div x-data="quickCustomerModal()"
    ...
    <div x-show="open"
        ...
        <form @submit.prevent="submit" class="p-5 space-y-4">
            ...
            <div x-show="genericError" x-cloak class="p-3 bg-red-50 border border-red-200 text-red-800 rounded text-sm" x-text="genericError"></div>
            ...
            <div>
                ...
                <input id="qc-name" type="text" x-model="form.name" x-ref="nameInput" required maxlength="255"
                       ...
                       :class="errors.name && '!border-red-400 !ring-red-400'">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input id="qc-gstin" type="text" x-model="form.gstin" maxlength="15"
                           ...
                           :class="errors.gstin && '!border-red-400 !ring-red-400'">
                    <p x-show="errors.gstin" x-cloak class="mt-1 text-xs text-red-600" x-text="errors.gstin"></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input id="qc-phone" type="tel" inputmode="tel" x-model="form.phone" maxlength="30"
                           ...
                           class="w-full border-gray-300 rounded-md shadow-sm text-sm focus:border-brand-500 focus:ring-brand-500"
                           :class="errors.phone && '!border-red-400 !ring-red-400'">
                ...
                <div>
                    ...
                    <input id="qc-email" type="email" x-model="form.email" maxlength="255"
                           ...
                           class="w-full border-gray-300 rounded-md shadow-sm text-sm focus:border-brand-500 focus:ring-brand-500"
                           :class="errors.email && '!border-red-400 !ring-red-400'">
