...
<body>
    ...
    @if ($summary['count'] === 0)
        <div class="empty">
            No cash sales found in this period.<br>
    ...
    <div class="footer">
        Generated by <strong>Apna Invoice</strong> · This is a computer-generated statement compiled from {{ $summary['count'] }} cash sale{{ $summary['count'] === 1 ? '' : 's' }} in your books. <strong>E. &amp; O.E.</strong>
    </div>
