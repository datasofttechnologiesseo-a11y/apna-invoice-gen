                ...
                <div class="mt-4 pt-4 border-t border-gray-100 flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <a href="{{ route('finance.expenses.export.csv', $exportQuery) }}"
                           class="inline-flex items-center justify-center gap-1.5 min-h-[36px] px-3 py-1.5 bg-brand-700 hover:bg-brand-800 text-white text-xs font-semibold rounded">
                        ...
                        <button onclick="window.print()" class="inline-flex items-center justify-center gap-1.5 min-h-[36px] px-3 py-1.5 bg-gray-800 hover:bg-gray-900 text-white text-xs font-semibold rounded">
