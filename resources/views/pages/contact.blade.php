...
<x-layouts.marketing
    ...
    <div class="not-prose mt-4 grid sm:grid-cols-2 gap-4">
        <a href="{{ config('seo.contact.whatsapp_url') }}?text={{ urlencode('Hi Apna Invoice team, I need help with…') }}" target="_blank" rel="noopener"
           class="block p-6 rounded-xl ring-1 ring-money-200 hover:ring-money-400 hover:shadow-sm transition bg-money-50/40">
            ...
            <div class="text-sm text-money-700 font-mono">{{ config('seo.contact.phone_display') }}</div>
    ...
    @endif
    @if ($errors->any())
        <div class="not-prose mb-4 p-4 bg-danger-50 border border-danger-200 text-danger-800 rounded">
