<x-layouts.marketing
    ...
    <div class="not-prose mt-4 grid sm:grid-cols-2 gap-4">
        <a href="mailto:sales@datasoft.example" class="block p-6 rounded-xl ring-1 ring-gray-200 hover:ring-brand-300 hover:shadow-sm transition bg-white">
            ...
            <div class="text-sm text-gray-500">sales@datasoft.example</div>
        </a>
        <a href="mailto:support@datasoft.example" class="block p-6 rounded-xl ring-1 ring-gray-200 hover:ring-brand-300 hover:shadow-sm transition bg-white">
            ...
            <div class="text-sm text-gray-500">support@datasoft.example</div>
        </a>
    </div>
